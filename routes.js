...
router.post("/teste/new", checkToken, async (req, res) => {
    try {
        const {nome} = req.body;
...
router.put('/teste/:id', checkToken, async (req, res) =>{
    try {
        const { nome } = req.body;
        const { id } = req.params; 
...
router.delete('/teste/:id', checkToken, async (req, res) =>{
    try {
        const { id } = req.params;
...
router.get('/teste', checkToken, async (req, res)=>{
    try{
